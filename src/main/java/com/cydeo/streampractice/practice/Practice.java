...
//                .findFirst().get().getLocation().getCountry().getRegion();
        ...
        return getAllDepartments().stream()
                .filter(department -> department.getDepartmentName().equals("IT"))
                .findFirst().orElseThrow(()->new Exception("No region found"))
...
//                .noneMatch(employee -> employee.getSalary() < 2000); // noneMatch - means will filter all salary above 2000;
...
//                .stream().collect(Collectors.toList());
    ...
    public static Long getMaxSalaryInAmericasRegion() throws Exception {
       return getAllEmployees().stream()
               ...
               .max(Comparator.comparing(Employee::getSalary)) // this is terminal operation
               .get().getSalary();
...
//                && employee.getLastName().equalsIgnoreCase("Eleni")
